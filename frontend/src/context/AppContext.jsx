...
const STORAGE_KEY = "della_resorts_state_v6";
...
const seedReservations = [
  ...
  { id: "GRP-0091", guestName: "TCS Group", roomType: "12 Rooms", roomNumber: "GRP-A", source: "group", arrival: "2026-02-18", expectedTime: "11:00 AM", nights: 2, adults: 32, children: 0, mobile: "+91 98201 11111", coordinatorName: "Sheetal Mehta", coordinatorMobile: "+91 98201 11111", primaryGuest: { fullName: "TCS Group Coordinator", mobile: "+91 98201 11111", email: "events@tcs.com", nationality: "Indian", country: "India" }, formSubmitted: false, idVerified: false, checkedIn: false, checkinStatus: "Group · 18/32", isGroup: true, groupTotal: 32, groupCheckedIn: 18, groupGuests: makeGroupGuests(), idsSync: { status: "synced", at: "08:45 AM" } },
